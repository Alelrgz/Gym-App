...
class NutritionistHomeScreen extends ConsumerWidget {
  ...
  const NutritionistHomeScreen({super.key, required this.navigationShell});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void goTo(int i) =>
        navigationShell.goBranch(i, initialLocation: i == navIndex);
          ...
          Padding(
            ...
            child: Column(
              children: List.generate(
                  NutritionistHomeScreen._navItems.length, (i) {
                final item = NutritionistHomeScreen._navItems[i];
